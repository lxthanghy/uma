...
function Check_InputThem() {
    ...
    if (txtMancc.value == '') {
        ...
        ckthem_mancc.innerHTML = `<i class="fa fa-exclamation-circle" aria-hidden="true"></i> Hãy nhập mã nhà cung cấp`;
    ...
    if (txtNgaynhap.value == '') {
        ...
        flag = false;
        ckthem_ngaynhap.innerHTML = `<i class="fa fa-exclamation-circle" aria-hidden="true"></i> Hãy nhập ngày nhập`;
    }
    else {
...
function Check_InputSua() {
    ...
    if (txtMancc.value == '') {
        txtMancc.classList.add('error');
        cksua_mancc.innerHTML = `<i class="fa fa-exclamation-circle" aria-hidden="true"></i> Hãy nhập mã nhà cung cấp`;
    ...
    if (txtNgaynhap.value == '') {
        ...
        flag = false;
        cksua_ngaynhap.innerHTML = `<i class="fa fa-exclamation-circle" aria-hidden="true"></i> Hãy nhập ngày nhập`;
    }
    else {
        txtNgaynhap.classList.remove('error');
