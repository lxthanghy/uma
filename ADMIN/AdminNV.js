...
function Them() {
    ...
    var txtchucvu = document.getElementById('chucvuThem');
...
function ClickUpdate(event) {
    ...
    txtchucvu.value = td[5].innerText;
...
function Update() {
    ...
    if (Check_InputSua()) {
        ...
        td_update[5].innerText = txtchucvu.value;
...
function Check_InputThem() {
    ...
    var ckthem_chucvu = document.querySelector('.ckthem_chucvu');
    ...
    if (txtchucvu.value == '') {
        txtchucvu.classList.add('error');
        ckthem_chucvu.innerHTML = `<i class="fa fa-exclamation-circle" aria-hidden="true"></i> Hãy nhập chức vụ`;
        ckthem_chucvu.style.color = "#D93025";
        flag = false;
    }
    else {
        txtchucvu.classList.remove('error');
        ckthem_chucvu.innerHTML = "";
    }
...
function Check_InputSua() {
    ...
    var cksua_chucvu = document.querySelector('.cksua_chucvu');
    ...
    if (txtchucvu.value == '') {
        txtchucvu.classList.add('error');
        cksua_chucvu.innerHTML = `<i class="fa fa-exclamation-circle" aria-hidden="true"></i> Hãy nhập chức vụ`;
        cksua_chucvu.style.color = "#D93025";
        flag = false;
    }
    else {
        txtchucvu.classList.remove('error');
        cksua_chucvu.innerHTML = "";
    }
    if (txtSdt.value == '' || txtSdt.value.search(numbers) == -1 || txtSdt.value.length != 10) {
        txtSdt.classList.add('error');
