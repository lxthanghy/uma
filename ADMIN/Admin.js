...
function Check_InputSua() {
    ...
    var txtGia = document.getElementById('giaSua');
    var txtSoluong = document.getElementById('soluongSua');
    var cksua_ma = document.querySelector('.cksua_ma');
    ...
    if (txtMa.value == '') {
        txtMa.classList.add('error');
        flag = false;
        cksua_ma.style.color = "#D93025";
        cksua_ma.innerHTML = `<i class="fa fa-exclamation-circle" aria-hidden="true"></i> Hãy nhập mã`;
