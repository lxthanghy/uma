...
function ClickUpdate(event) {
    ...
    txtDiachi.value = td[3].innerText;
    txtSdt.value = td[4].innerText;
    txtEmail.value = td[5].innerText;
...
function Update() {
    ...
    if (Check_InputSua()) {
        ...
        td_update[3].innerText = txtDiachi.value;
        td_update[4].innerText = txtSdt.value;
        td_update[5].innerText = txtEmail.value;
        nenden.classList.remove('ndhr');
        form_sua.classList.remove('suahr');
